...
const Home: NextPage = () => {
  ...
  return (
    <div className="p-20 space-y-20 max-w-5xl mx-auto">
      <h1 className="text-5xl font-bold">Your stories</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-2">
        {postsResponse.data?.posts.edges.map((edge) => {
          return (
            <Link href={`/posts/${edge.node.slug}/edit`}>
              <a className="prose border rounded-xl inline-block p-5 h-36 overflow-hidden">
